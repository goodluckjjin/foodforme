                ...
                <div className="container">
                    <div className="myPage">
                        ...
                        <div className="write_btn">
                            <NavLink className="write_link_btn" to="/mypage/sns_write">Write</NavLink>
                        </div>
                    </div>
